...
- [Vipin — User Profile](Vipin-Profile.md) — TPM/PM, Bay Area job search, active projects and working style
- [VP Report Generator](VP-Report-Generator.md) — Jira pipeline → PPTX/Slides exec reports, GitHub Actions + Claude scheduled tasks
- [VP Recipe Agent Evals](VP-Recipe-Agent-Evals.md) — LLM evals homework: recipe chatbot, bulk testing, failure mode taxonomy, 3 Gulfs
- [VP Substitution Agent Evals](VP-Substitution-Agent-Evals.md) — Completed eval: ingredient substitution chatbot, 12-step methodology, V4 checker, TNR 100%
